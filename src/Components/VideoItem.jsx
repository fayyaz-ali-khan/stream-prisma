  ...
  return (
    <>
      <div className="video-item d-flex align-items-center mb-4">
        ...
        <div className="video-actions d-flex align-items-center" style={{marginTop:'-7px'}}>
          <Link to={'/schdulestreams'}><button className="btn btn-new2">Stream Video</button></Link>
        </div>
        <Dropdown>
                                  <Dropdown.Toggle
                                    variant="light"
